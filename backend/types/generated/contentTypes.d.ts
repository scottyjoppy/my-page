...
export interface ApiSerieSerie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::serie.serie'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    serie_slug: Schema.Attribute.String & Schema.Attribute.Required;
    serie_tagline: Schema.Attribute.String & Schema.Attribute.Required;
    serie_title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
